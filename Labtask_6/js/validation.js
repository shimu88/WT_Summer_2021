function validateForm() {
    ...
    if(email == ""){
        document.getElementById("err-email").innerHTML="Please valid email";
        return false;
    }else if(!res){

      document.getElementById("err-email").innerHTML="Email is not correct";
      return false; 
    }
    if (pass == "") {
     document.getElementById("err-pass").innerHTML="Please fill out password";
      return false;
        ...
        document.getElementById("err-pass").innerHTML="Password must be at least 6 characters long";
    }
    
    if (cmt == "" || cmt.length < 6 ) {
        document.getElementById("err-cmt").innerHTML="Write good comments";
        return false;
    }
